export const aboutBlocks = [
  {
    term: "Historia",
    text: "Desde 2014 operamos rutas en Sonora, Sinaloa y Baja California con flota propia.",
  },
  {
    term: "Misión",
  ...
  {
    term: "Visión",
    text: "Ser el operador de referencia en logística terrestre del noroeste mexicano.",
  },
  {
    term: "Valores",
    text: "Seguridad, honestidad, responsabilidad y cercanía con cada cliente.",
  },
];
...
export const quotes = [
  {
    text: "Apache cumple ventanas de entrega sin sorpresas. El monitoreo nos da tranquilidad.",
    author: "Laura Méndez",
    role: "Directora de Operaciones, AgroPacífico",
  },
  {
    text: "Trato directo con quien decide. Eso marca la diferencia cuando la carga es urgente.",
    author: "Roberto Ibarra",
    role: "Gerente de Logística, RefriMex",
  },
];

export const posts = [
  {
    title: "Nueva ruta Hermosillo-Guaymas con salida diaria",
    date: "12 Jun 2026",
    seed: "blog1",
  },
  {
    title: "Certificación SCT renovada para flota completa",
    date: "28 May 2026",
    seed: "blog2",
  },
  {
    title: "Botón de pánico activo en todas las unidades",
    date: "15 May 2026",
    seed: "blog3",
  },
];
