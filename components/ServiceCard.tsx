...
export function ServiceCard({ name, desc, icon }: Props) {
  ...
  return (
    <article className="group relative min-h-[15.75rem] overflow-hidden bg-nav px-4 py-5 text-base transition-colors duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] hover:bg-highlight">
      <div className="flex h-full flex-col items-center justify-center gap-2.5 transition-opacity duration-300 group-hover:pointer-events-none group-hover:opacity-0">
        <ServiceIcon src={src} className="h-[2.2rem] w-[2.2rem] text-base" />
